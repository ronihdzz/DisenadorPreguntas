...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.btn_mas.setGeometry(QtCore.QRect(680, 10, 89, 25))
        self.btn_mas.setObjectName("btn_mas")
        self.btn_borrar = QtWidgets.QPushButton(Form)
        self.btn_borrar.setGeometry(QtCore.QRect(880, 10, 89, 25))
        self.btn_borrar.setObjectName("btn_borrar")
        self.btn_ver = QtWidgets.QPushButton(Form)
        self.btn_ver.setGeometry(QtCore.QRect(780, 10, 89, 25))
        self.btn_ver.setObjectName("btn_ver")
        self.listWidget_juego = QtWidgets.QStackedWidget(Form)
        self.listWidget_juego.setGeometry(QtCore.QRect(100, 40, 861, 401))
        self.listWidget_juego.setToolTipDuration(0)
        self.listWidget_juego.setStyleSheet("padding:0px;\n"
"\n"
"\n"
"")
        self.listWidget_juego.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.listWidget_juego.setFrameShadow(QtWidgets.QFrame.Plain)
        self.listWidget_juego.setObjectName("listWidget_juego")

        self.retranslateUi(Form)
        self.listWidget_juego.setCurrentIndex(-1)
