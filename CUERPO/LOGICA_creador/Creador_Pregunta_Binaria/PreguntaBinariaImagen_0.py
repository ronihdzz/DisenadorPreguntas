...
##############################################################
from CUERPO.DISENO_creador.Creador_Pregunta_Binaria.modRespBinariaImagen0_d import Ui_Form
...
class PreguntaBinariaImagen_0(QtWidgets.QWidget, Ui_Form):
...
if __name__ == "__main__":
    ...
    application = PreguntaBinariaImagen_0()
    application.show()
    app.exec()
    #sys.exit(app.exec())
