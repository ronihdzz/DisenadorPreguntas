...
##############################################################
from CUERPO.DISENO_creador.Creador_Ventanas_Dialogo.PanelCuestionariosDescargados_d import Ui_Form
...
class PanelCuestionariosDescargados(QWidget,Ui_Form):
...
if __name__ == '__main__':
    app = QApplication([])
    application = PanelCuestionariosDescargados()
    application.show()
    app.exit(app.exec())