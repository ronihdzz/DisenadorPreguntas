...
##############################################################
from CUERPO.DISENO_creador.Creador_InteractuardorLocal.InteractuadorMisCuestionarios_d import Ui_Form
###############################################################
...
class InteractuadorMisCuestionarios(QWidget,Ui_Form):
...
if __name__ == '__main__':
    app = QApplication([])
    application = InteractuadorMisCuestionarios()
    application.show()
    app.exit(app.exec())
