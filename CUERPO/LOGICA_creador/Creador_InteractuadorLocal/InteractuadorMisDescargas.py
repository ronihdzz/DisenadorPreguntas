...
##############################################################
from CUERPO.DISENO_creador.Creador_InteractuardorLocal.InteractuadorMisDescargas_d import Ui_Form
...
class InteractuadorMisDescargas(QWidget,Ui_Form):
...
if __name__ == '__main__':
    app = QApplication([])
    application = InteractuadorMisDescargas()
    application.show()
    app.exit(app.exec())