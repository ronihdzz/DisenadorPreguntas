...
##############################################################
from DISENO.Creador_Main.CreadorPreguntasMain_d import Ui_MainWindow
from LOGICA.Creador_Main.menuTipoPreguntas import menuTipoPreguntas
from LOGICA.Creador_Pregunta_Binaria.PreguntaBinaria import PreguntaBinaria
from LOGICA.Creador_Pregunta_Multiple.PreguntaMultiple import PreguntaMultiple
...
from LOGICA.Creador_Ejecutador.CreadorCuestionarios import EjecutadorCuestionario
...
class CreadorPreguntas(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self,nombreCreador="ANONIMO",nombreCuestionario=""):
    ...
    def abrirCuestionario(self):
        ...
        #Checamos si ya existe la carpeta
    ...
    def ejecutarCuestionario(self):
        self.ejecutadorCuestionario= EjecutadorCuestionario(nombreCuestionario=self.nombreCarpeta+"/"+self.nombreCuestionario,
                                                            direc_carpetaImagenes=self.nombreCarpetaImagenes)
...
if __name__ == "__main__":
    ...
    application = CreadorPreguntas(nombreCreador="Roni",nombreCuestionario="Roni")
    application.show()
    app.exec()
    #sys.exit(app.exec())
