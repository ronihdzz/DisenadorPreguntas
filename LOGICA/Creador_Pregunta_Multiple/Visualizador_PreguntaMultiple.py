...
##############################################################
from DISENO.Creador_Pregunta_Multiple.VisualizadorMultiples_d import Ui_Form
...
class VisualizadorPreguntaMultiple(QtWidgets.QWidget, Ui_Form):
...
####################################################################################################################################
    ...
    def mostrarRespuesta(self,respuesta):
        self.controlABSOLUTO_botones.setAllRespuestas([0, 0, 0, 0])  # primero limpiamos,luego mostramos
