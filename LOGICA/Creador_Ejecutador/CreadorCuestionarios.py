...
class EjecutadorCuestionario(QtWidgets.QWidget, Ui_Form):
    def __init__(self,nombreCuestionario="",direc_carpetaImagenes="",nombreCreador="ANONIMO"):
...
##############################################################################################################################
        ...
        # creando multiples ventanas...
        self.ventanas = []
        self.ventanas.append( VisualizadorPreguntaBinaria(direc_carpetaImagenes=direc_carpetaImagenes) )  # pregunta binaria
        self.ventanas.append( VisualizadorPreguntaMultiple(direc_carpetaImagenes=direc_carpetaImagenes) ) #pregunta multiple
        self.ventanas.append( VisualizadorPregunta_CheckBox(direc_carpetaImagenes=direc_carpetaImagenes) ) #visualizador pregunta checkbox
        self.ventanas.append(  VisualizadorPregunta_Abierta(direc_carpetaImagenes=direc_carpetaImagenes) ) #visualizador de pregunta abierta...
...
if __name__ == "__main__":
    ...
    nombreCuestionario = "Pedro"
    nombreCarpeta =RecursosCreadorCuestionarios.DIREC_CUESTIONARIOS_EDICION + nombreCuestionario
    direcCuestionario=nombreCarpeta+"/"+nombreCuestionario
    direcCarpetaImagen=nombreCarpeta+RecursosCreadorCuestionarios.ID_CARPETA_IMAGENES+nombreCuestionario

    application = EjecutadorCuestionario(nombreCuestionario=direcCuestionario,direc_carpetaImagenes=direcCarpetaImagen)
    application.show()
    app.exec()
    #sys.exit(app.exec())
